...
if __name__ == "__main__":
    ...
    # paths = ['/cs/3dlg-project/3dlg-hcvc/3dhoi/templates/simple_template_inits/infer_0_2005_0.5',
    #          '/cs/3dlg-project/3dlg-hcvc/3dhoi/templates/simple_template_inits/infer_0_2005_1.0',
    #          '/cs/3dlg-project/3dlg-hcvc/3dhoi/templates/simple_template_inits/infer_4_2005_0.5',
    #          '/cs/3dlg-project/3dlg-hcvc/3dhoi/templates/simple_template_inits/infer_2_2005_0.5',
    #          '/cs/3dlg-project/3dlg-hcvc/3dhoi/templates/simple_template_inits/infer_2_2005_1.0',
    #          '/cs/3dlg-project/3dlg-hcvc/3dhoi/templates/simple_template_inits/infer_6_2005_0.5',]

    # obj_mesh = []
    # idx = 0
    # for path in paths:
        
    #     obj_mesh_1 = o3d.io.read_triangle_mesh(f"{path}/00002_basepart.obj")
    #     obj_mesh_1.compute_vertex_normals()
    #     obj_mesh_1.paint_uniform_color([0., 1., 0.])

    #     obj_mesh_2 = o3d.io.read_triangle_mesh(f"{path}/00002_movpart.obj")
    #     obj_mesh_2.compute_vertex_normals()
    #     obj_mesh_2.paint_uniform_color([0., 0., 1.])

    #     if idx == 1:
    #         obj_mesh_1.translate((3,0,0))
    #         obj_mesh_2.translate((3,0,0))
    #     if idx == 2:
    #         obj_mesh_1.translate((6,0,0))
    #         obj_mesh_2.translate((6,0,0))
    #     if idx == 3:
    #         obj_mesh_1.translate((0,-3,0))
    #         obj_mesh_2.translate((0,-3,0))
    #     if idx == 4:
    #         obj_mesh_1.translate((3,-3,0))
    #         obj_mesh_2.translate((3,-3,0))
    #     if idx == 5:
    #         obj_mesh_1.translate((6,-3,0))
    #         obj_mesh_2.translate((6,-3,0))
    #     if idx > 5:
    #         continue

    #     obj_mesh.append(obj_mesh_1)
    #     obj_mesh.append(obj_mesh_2)
    #     idx += 1

    obj_mesh_1 = o3d.io.read_triangle_mesh("/localhome/xsa55/Xiaohao/Articulation3D/articulation3d/output_test/frame_0000/arti_pred.obj")
    obj_mesh_1.compute_vertex_normals()
    obj_mesh_1.paint_uniform_color([0., 1., 0.])

    # obj_mesh_2 = o3d.io.read_triangle_mesh("/project/3dlg-hcvc/3dhoi/templates/simple_template_inits/infer_0_2005_1.0/00002_movpart.obj")
    # obj_mesh_2.compute_vertex_normals()
    # obj_mesh_2.paint_uniform_color([0., 0., 1.])


    # obj_mesh_3 = o3d.io.read_triangle_mesh("/project/3dlg-hcvc/3dhoi/templates/simple_template_inits/infer_0_2005_0.5/00002_basepart.obj")
    # obj_mesh_3.compute_vertex_normals()
    # obj_mesh_3.paint_uniform_color([0., 1., 0.])
    # obj_mesh_3.translate((2,0,0))

    # obj_mesh_4 = o3d.io.read_triangle_mesh("/project/3dlg-hcvc/3dhoi/templates/simple_template_inits/infer_0_2005_0.5/00002_movpart.obj")
    # obj_mesh_4.compute_vertex_normals()
    # obj_mesh_4.paint_uniform_color([0., 0., 1.])
    # obj_mesh_4.translate((2,0,0))
    # plane_norm = np.load('/localhome/xsa55/Xiaohao/Articulation3D/articulation3d/output/output_val_extrude/dishwasher/b001-0007/frame_0000/normal.npy')
    # arrow_mesh = get_arrow(end = plane_norm)
    # # pdb.set_trace()
    ...
    # Final Visualization
    # o3d.visualization.draw_geometries([obj_mesh_1, arrow_mesh])
    # # o3d.visualization.draw_geometries([obj_mesh_1, arrow_mesh, world]) + camera)
    # pdb.set_trace()

    o3d.visualization.draw_geometries(obj_mesh_1)